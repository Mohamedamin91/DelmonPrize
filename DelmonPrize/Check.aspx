<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check.aspx.cs" Inherits="DelmonPrize.Confirm" %>
					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								<h2>43<sup style= "font-size:20px; font-family:'sans-serif' ">rd</sup> -  Delmon Annual Party Anniversary-2024</h2>
		                 ...
		                 <asp:Label ID="lblMsg2" CssClass="mb-4" style="color: #eb2d2e ; font-size :24px; font-weight:bold; " runat="server" ></asp:Label>
			      		...
			      		<div class="form-group mb-3">
			      			<label class="label" for="name"></label>
							     <asp:TextBox ID="txtUserInput" CssClass="form-control" placeholder="Enter Your ID/IQama" style="color:gray" runat="server" MaxLength="10"  Enabled="True"></asp:TextBox>	
<%--		                 	    <asp:RegularExpressionValidator runat="server"  ValidationExpression="^[0-9]{10}$" ControlToValidate="txtUserInput" ErrorMessage="ID/IQama must Be in numbers :(" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small"></asp:RegularExpressionValidator>                 --%>
